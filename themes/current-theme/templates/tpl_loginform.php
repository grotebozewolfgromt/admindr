            ...
            <div id="loginfieldouterbox">
                ...
                <div id="loginfieldbox">            
                    ...
                    <?php
                        ...
                        if ($objLoginController->getUseSigninWithGoogle())
                            echo '<a href="'.$objLoginController->getURLGoogleAuth().'">'.transcms('loginform_signinwithgoogle_button','Sign In with Google').'</a>';
