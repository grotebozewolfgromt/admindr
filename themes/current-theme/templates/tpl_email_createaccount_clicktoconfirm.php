...
<br>
<?php echo transcms('createaccount_email_clicktoactivate_body_dontwanttoactivate', 'If you don\'t want to activate the account, you can ignore this email, the account will be automatically deleted.'); ?><br>
<br>
