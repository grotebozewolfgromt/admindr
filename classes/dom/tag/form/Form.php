 ...
 *     $objText = new InputText();
    ...
    echo 'waarde na submitten:'.$objText->getContentsSubmitted()->getValue();
...
//             $objXMLElement->setAttribute('action', $this->getAction());

//         //method toevoegen
//         if (strlen($this->getMethod()) > 0 )
//         {
//             if (($this->getMethod() == 'post') || ($this->getMethod() == 'get'))
//                 $objXMLElement->setAttribute('method', $this->getMethod());
//             else
//                 throw new Exception ('getXMLNodeSpecificToNode(): the method of the form should be either "method", "post" or empty, the method is now set to:"'.$this->getMethod().'" wich is not allowed according to the w3c.');
//         }

//         //enctype toevoegen
//         if (strlen($this->getEnctype()) > 0 )
//             $objXMLElement->setAttribute('enctype', $this->getEnctype());
//     }
