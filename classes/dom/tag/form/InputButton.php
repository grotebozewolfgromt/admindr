...
class InputButton extends InputAbstract
{
	...
	/**
	 * copy all the properties from InputSubmit ($objSubmit) to this button
	 */
	// public function copyAttributesInputSubmit(InputSubmit &$objSubmit)
	// {
	// 	$this->setID($objSubmit->getID());
	// 	$this->setName($objSubmit->getName());
	// 	$this->setClass($objSubmit->getClass());
	// 	$this->setValue($objSubmit->getValue());
	// 	$this->setOnchange($objSubmit->getOnchange());
	// 	$this->setOnclick($objSubmit->getOnclick());
	// 	$this->setStyle($objSubmit->getStyle());
	// }
}
?>