 ...
 */
class TSysSettings extends TModel
{
	...
	*/
	public function defineTable()
	{
		...
		$this->setFieldType(TSysSettings::FIELD_TYPE, CT_INTEGER);
	...
	*/
	...
	{
		return GLOBAL_DB_TABLEPREFIX.'SysSettings';
	}
	...
	*/
	...
	public function createSettingsDBByBLArr($sModule, $arrSettingsEntriesBL)
	{
		...
		foreach ($arrKeys as $sArrKey)
		{
			...
			// $objSettings->saveToDB();
		}
		return $objSettings->saveToDBAll();
	...
	{
		$objSettings = new TSysSettings();
		$objSettings->findLike(TSysSettings::FIELD_RESOURCE, $sModule.SETTINGS_RESOURCESEPARATOR.'%');
	...
	private function addSettingsToDBFromBL($sModBL, $arrSettingsEntriesBL)
	{
		...
		$objSettingsDBExist->findLike(TSysSettings::FIELD_RESOURCE, $sModBL.SETTINGS_RESOURCESEPARATOR.'%');
