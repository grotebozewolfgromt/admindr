 ...
 * @author drenirie
 */
class TSysCMSPermissions extends TPermissionsAbstract
{
    ...
    {
        return GLOBAL_DB_TABLEPREFIX.'SysCMSPermissions';
    }
    ...
    */
    public function defineTable()
    {
        ...
        $this->setFieldForeignKeyField(TSysCMSPermissions::FIELD_USERROLEID, TModel::FIELD_ID);
        $this->setFieldForeignKeyJoin(TSysCMSPermissions::FIELD_USERROLEID);
        $this->setFieldForeignKeyActionOnUpdate(TSysCMSPermissions::FIELD_USERROLEID, TModel::FOREIGNKEY_REFERENCE_CASCADE);
        $this->setFieldForeignKeyActionOnDelete(TSysCMSPermissions::FIELD_USERROLEID, TModel::FOREIGNKEY_REFERENCE_CASCADE); //when user-role is deleted, also permissions are deleted
    ...
    */
    ...
    {
        return 'pdfL_kdl1'.$this->get(TPermissionsAbstract::FIELD_RESOURCE).'_qwwd1'.$this->get(TPermissionsAbstract::FIELD_RESOURCE).boolToInt($this->getAllowed()).boolToInt($this->getUserRoleID()).'e03-jajaikwileenkoekje';
    }
    ...
    public function deletePermissionsForModule($sInternalModuleName)
    {
        ...
        $objPerm->findLike(TSysCMSPermissions::FIELD_RESOURCE, $sInternalModuleName.AUTH_RESOURCESEPARATOR.'%');
    ...
    private function addPermToDBIfNotExistsInternal($sModule, $sCategory, $sOperation, $iUsergroupID, $bDefaultAllowed = true)
    {
        ...
        $objPermDB = new TSysCMSPermissions();
        $objPermDB->select(array(TModel::FIELD_ID));
