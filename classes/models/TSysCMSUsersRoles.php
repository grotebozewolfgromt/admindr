 ...
 * @author drenirie
 */
class TSysCMSUsersRoles extends TUsersRolesAbstract
{
    ...
    {
        return GLOBAL_DB_TABLEPREFIX.'SysCMSUsersRoles';
    }
    ...
    public function install($arrPreviousDependenciesModelClasses = null)
    {
        ...
        {         
            ...
            if (!$this->saveToDB())
            {
                error(__CLASS__.': saving new user '.TSysCMSUsersRoles::ROLENAME_DEFAULT_ADMINISTRATORS);
                return false;
            }
            ...
            if (!$this->saveToDB())
            {
                error(__CLASS__.': saving new user '.TSysCMSUsersRoles::ROLENAME_DEFAULT_BASICACCOUNTADMIN);
                return false;
            }       
            ...
            if (!$this->saveToDB())
            {
                error(__CLASS__.': saving new user '.TSysCMSUsersRoles::ROLENAME_DEFAULT_ADVANCEDACCOUNTADMIN);
                return false;
            }       
            ...
            if (!$this->saveToDB())
            {
                error(__CLASS__.': saving new user '.TSysCMSUsersRoles::ROLENAME_DEFAULT_PROACCOUNTADMIN);
                return false;
            }                
            ...
            if (!$this->saveToDB())
            {
                error(__CLASS__.': saving new user '.TSysCMSUsersRoles::ROLENAME_DEFAULT_ACCOUNTUSERS);
                return false;
            }       
