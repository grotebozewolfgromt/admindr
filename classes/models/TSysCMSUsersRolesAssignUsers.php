 ...
 * @author drenirie
 */
class TSysCMSUsersRolesAssignUsers extends TModel
{
    ...
    */
    public function defineTable()
    {
        ...
        $this->setFieldForeignKeyActionOnUpdate(TSysCMSUsersRolesAssignUsers::FIELD_ROLEID, TModel::FOREIGNKEY_REFERENCE_CASCADE);
        $this->setFieldForeignKeyActionOnDelete(TSysCMSUsersRolesAssignUsers::FIELD_ROLEID, TModel::FOREIGNKEY_REFERENCE_CASCADE);
        ...
        $this->setFieldForeignKeyActionOnUpdate(TSysCMSUsersRolesAssignUsers::FIELD_ALLOWEDASSIGNUSERSROLEID, TModel::FOREIGNKEY_REFERENCE_CASCADE);
        $this->setFieldForeignKeyActionOnDelete(TSysCMSUsersRolesAssignUsers::FIELD_ALLOWEDASSIGNUSERSROLEID, TModel::FOREIGNKEY_REFERENCE_CASCADE);
    ...
    {
        return GLOBAL_DB_TABLEPREFIX.'SysCMSUsersRolesAssignUsers';
    }
