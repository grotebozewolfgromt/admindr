...
include_once GLOBAL_PATH_LOCAL_VENDOR.DIRECTORY_SEPARATOR.'phpmailer'.DIRECTORY_SEPARATOR.'src'.DIRECTORY_SEPARATOR.'PHPMailer.php';
include_once GLOBAL_PATH_LOCAL_VENDOR.DIRECTORY_SEPARATOR.'phpmailer'.DIRECTORY_SEPARATOR.'src'.DIRECTORY_SEPARATOR.'Exception.php';
// include_once GLOBAL_PATH_LOCAL_VENDOR.DIRECTORY_SEPARATOR.'phpmailer'.DIRECTORY_SEPARATOR.'src'.DIRECTORY_SEPARATOR.'POP3.php';
// include_once GLOBAL_PATH_LOCAL_VENDOR.DIRECTORY_SEPARATOR.'phpmailer'.DIRECTORY_SEPARATOR.'src'.DIRECTORY_SEPARATOR.'SMTP.php';
// include_once GLOBAL_PATH_LOCAL_VENDOR.DIRECTORY_SEPARATOR.'phpmailer'.DIRECTORY_SEPARATOR.'src'.DIRECTORY_SEPARATOR.'OAuth.php';
...
class TMailSend
{
    ...
    {        
        ...
        {
            $this->sErrorMessage = transs(__CLASS__.'_errormessage_flooddetected', 'Sorry, you sent too many emails at once');
