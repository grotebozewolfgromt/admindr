...
//    }
     ...
     * 
     * @global TCountrySettings $objCountrySettings
    ...
    public function getDayNameShort($iDayNumberOfWeek = 0)
    {
        ...
        {
            case 1:
                return $objCountrySettings->getCountrySetting(TCountrySettings::MONDAY_SHORT);
                break;
            case 2:
                return $objCountrySettings->getCountrySetting(TCountrySettings::TUESDAY_SHORT);
                break;
            case 3:
                return $objCountrySettings->getCountrySetting(TCountrySettings::WEDNESDAY_SHORT);
                break;
            case 4:
                return $objCountrySettings->getCountrySetting(TCountrySettings::THURSDAY_SHORT);
                break;   
            case 5:
                return $objCountrySettings->getCountrySetting(TCountrySettings::FRIDAY_SHORT);
                break;              
            case 6:
                return $objCountrySettings->getCountrySettings()->getCountrySetting(TCountrySettings::SATURDAY_SHORT);
                break;              
            case 7:
                return $objCountrySettings->getCountrySetting(TCountrySettings::SUNDAY_SHORT);
                break;                                          
        }             
    }
    ...
    public function getDayName($iDayNumberOfWeek = 0)
    {
        ...
        {
            case 1:
                return $objCountrySettings->getCountrySetting(TCountrySettings::MONDAY);
                break;
            case 2:
                return $objCountrySettings->getCountrySetting(TCountrySettings::TUESDAY);
                break;
            case 3:
                return $objCountrySettings->getCountrySetting(TCountrySettings::WEDNESDAY);
                break;
            case 4:
                return $objCountrySettings->getCountrySetting(TCountrySettings::THURSDAY);
                break;   
            case 5:
                return $objCountrySettings->getCountrySetting(TCountrySettings::FRIDAY);
                break;              
            case 6:
                return $objCountrySettings->getCountrySetting(TCountrySettings::SATURDAY);
                break;              
            case 7:
                return $objCountrySettings->getCountrySetting(TCountrySettings::SUNDAY);
                break;                                          
        }             
    }    
    ...
    public function getMonthName($iMonthNumberOfYear = 0)
    {
        ...
        {
            case 1:
                return $objCountrySettings->getCountrySetting(TCountrySettings::JANUARY);
                break;
            case 2:
                return $objCountrySettings->getCountrySetting(TCountrySettings::FEBRUARY);
                break;
            case 3:
                return $objCountrySettings->getCountrySetting(TCountrySettings::MARCH);
                break;
            case 4:
                return $objCountrySettings->getCountrySetting(TCountrySettings::APRIL);
                break;   
            case 5:
                return $objCountrySettings->getCountrySetting(TCountrySettings::MAY);
                break;              
            case 6:
                return $objCountrySettings->getCountrySetting(TCountrySettings::JUNE);
                break;              
            case 7:
                return $objCountrySettings->getCountrySetting(TCountrySettings::JULY);
                break;                                          
            case 8:
                return $objCountrySettings->getCountrySetting(TCountrySettings::AUGUST);
                break;                                          
            case 9:
                return $objCountrySettings->getCountrySetting(TCountrySettings::SEPTEMBER);
                break;                                          
            case 10:
                return $objCountrySettings->getCountrySetting(TCountrySettings::OCTOBER);
                break;                                          
            case 11:
                return $objCountrySettings->getCountrySetting(TCountrySettings::NOVEMBER);
                break;                                          
            case 12:
                return $objCountrySettings->getCountrySetting(TCountrySettings::DECEMBER);
                break;                                          
    ...
    public function getMonthNameShort($iMonthNumberOfYear = 0)
    {
        ...
        {
            case 1:
                return $objCountrySettings->getCountrySetting(TCountrySettings::JANUARY_SHORT);
                break;
            case 2:
                return $objCountrySettings->getCountrySetting(TCountrySettings::FEBRUARY_SHORT);
                break;
            case 3:
                return $objCountrySettings->getCountrySetting(TCountrySettings::MARCH_SHORT);
                break;
            case 4:
                return $objCountrySettings->getCountrySetting(TCountrySettings::APRIL_SHORT);
                break;   
            case 5:
                return $objCountrySettings->getCountrySetting(TCountrySettings::MAY_SHORT);
                break;              
            case 6:
                return $objCountrySettings->getCountrySetting(TCountrySettings::JUNE_SHORT);
                break;              
            case 7:
                return $objCountrySettings->getCountrySetting(TCountrySettings::JULY_SHORT);
                break;                                          
            case 8:
                return $objCountrySettings->getCountrySetting(TCountrySettings::AUGUST_SHORT);
                break;                                          
            case 9:
                return $objCountrySettings->getCountrySetting(TCountrySettings::SEPTEMBER_SHORT);
                break;                                          
            case 10:
                return $objCountrySettings->getCountrySetting(TCountrySettings::OCTOBER_SHORT);
                break;                                          
            case 11:
                return $objCountrySettings->getCountrySetting(TCountrySettings::NOVEMBER_SHORT);
                break;                                          
            case 12:
                return $objCountrySettings->getCountrySetting(TCountrySettings::DECEMBER_SHORT);
                break;                                          
    ...
    private function translateAMPM($sAMPM)
    {
        ...
        {
            case 'am':
                return $objCountrySettings->getCountrySetting(TCountrySettings::TIMEFORMAT_ANTEMEDIDIUM_SHORT);
                break;
            case 'pm':
                return $objCountrySettings->getCountrySetting(TCountrySettings::TIMEFORMAT_POSTMERIDIUM_SHORT);
                break;            
        }             
    }      
    ...
    * @global TCountrySettings $objCountrySettings if format == '' then tries to determin the format by looking at TCountrySettings::DATEFORMAT_DEFAULT
    * @param $sFormatLocaleSetting string with a TLocale constant setting, i.e. TCountrySettings::DATEFORMAT_MEDIUM.  Empty string = use default
    ...
    * convert a date to a TDateTime 
     * 
    * @global TCountrySettings $objCountrySettings if format == '' then tries to determine the format by looking at TCountrySettings::DATEFORMAT_DEFAULT
    ...
    */
    public function setDateAsString($sDate, $sPHPDateFormat = '')
    {
        ...
        if ($sPHPDateFormat == '')            
            $sPHPDateFormat = $objCountrySettings->getCountrySetting(TCountrySettings::DATEFORMAT_DEFAULT);
    ...
    */    
    public function getDateTimeAsString($sPHPDateFormat = '')
    {
        ...
        if ($sPHPDateFormat == '')            
            $sPHPDateFormat = $objCountrySettings->getCountrySetting(TCountrySettings::DATETIME_FORMAT_DEFAULT);
