...
$tblSoorten = $sDBTablePrefix."Soorten";//INVULLEN!
$tblSoortenTags = $sDBTablePrefix."SoortenTags";//INVULLEN!
$tblPlaatsenSoorten = $sDBTablePrefix.'PlaatsenSoorten';//INVULLEN!
...
//==pagina
$sNaamPagina = "Gelegenheden"; 				//INVULLEN! 	Dit is de naam van de pagina van deze module. Deze pagina komt in het hoofdmenu te staan: string
...
//grootte plaatjes
$gelegenheidimagekleinwidth = 300; //100 = 100 pixels//INVULLEN!
$gelegenheidimagekleinheight = 300; //100 = 100 pixels//INVULLEN!
$gelegenheidimagekleinquality = 75; //85 = 85 procent//INVULLEN!
$gelegenheidimagegrootwidth = 1200; //100 = 100 pixels//INVULLEN!
$gelegenheidimagegrootheight = 1200; //100 = 100 pixels//INVULLEN!
$gelegenheidimagegrootquality = 80; //85 = 85 procent//INVULLEN!
