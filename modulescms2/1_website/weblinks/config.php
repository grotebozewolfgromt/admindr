...
$tblWeblinks = $sDBTablePrefix."Weblinks";//INVULLEN!
...
//==pagina
$sNaamPagina = "Weblinks"; 				//INVULLEN! 	Dit is de naam van de pagina van deze module. Deze pagina komt in het hoofdmenu te staan: string
