...
class list_websites extends TCRUDListController
{
    ...
    public function execute()
    {
        ...
        $arrTableColumnsShow = array(
            array('', TSysWebsites::FIELD_WEBSITENAME, transm($sCurrentModule, 'overview_column_'.TSysWebsites::FIELD_WEBSITENAME, 'website name')),
            array('', TSysWebsites::FIELD_URL, transm($sCurrentModule, 'overview_column_'.TSysWebsites::FIELD_URL, 'url')),
            array($objTempLang::getTable(), TSysLanguages::FIELD_LANGUAGE, transm($sCurrentModule, 'overview_column_'.TSysLanguages::FIELD_LANGUAGE, 'default')),
                );
    ...
    {
        global $sCurrentModule;
        return transm($sCurrentModule, TRANS_MODULENAME_TITLE, 'Websites');
    }
