...
class TTransactionsLines extends TModel
{
	const FIELD_TRANSACTIONSID 				= 'iTransactionsID'; //the id of the parent invoice record
	const FIELD_QUANTITY					= 'dcQuantity'; //TDecimal: amount of good/serviceconsumed
	...
	*/
	public function defineTable()
	{
		...
		$this->setFieldForeignKeyField(TTransactionsLines::FIELD_TRANSACTIONSID, TModel::FIELD_ID);
		$this->setFieldForeignKeyJoin(TTransactionsLines::FIELD_TRANSACTIONSID);
		$this->setFieldForeignKeyActionOnUpdate(TTransactionsLines::FIELD_TRANSACTIONSID, TModel::FOREIGNKEY_REFERENCE_CASCADE);
		$this->setFieldForeignKeyActionOnDelete(TTransactionsLines::FIELD_TRANSACTIONSID, TModel::FOREIGNKEY_REFERENCE_CASCADE); 
		...
		$this->setFieldDefaultValue(TTransactionsLines::FIELD_UNITPRICEEXCLVAT, 0);
		$this->setFieldType(TTransactionsLines::FIELD_UNITPRICEEXCLVAT, CT_CURRENCY);
		$this->setFieldLength(TTransactionsLines::FIELD_UNITPRICEEXCLVAT, 0);
		$this->setFieldDecimalPrecision(TTransactionsLines::FIELD_UNITPRICEEXCLVAT, 4);
		$this->setFieldPrimaryKey(TTransactionsLines::FIELD_UNITPRICEEXCLVAT, false);
		$this->setFieldNullable(TTransactionsLines::FIELD_UNITPRICEEXCLVAT, false);
		$this->setFieldEnumValues(TTransactionsLines::FIELD_UNITPRICEEXCLVAT, null);
		$this->setFieldUnique(TTransactionsLines::FIELD_UNITPRICEEXCLVAT, false);
		$this->setFieldIndexed(TTransactionsLines::FIELD_UNITPRICEEXCLVAT, false);
		$this->setFieldForeignKeyClass(TTransactionsLines::FIELD_UNITPRICEEXCLVAT, null);
		$this->setFieldForeignKeyTable(TTransactionsLines::FIELD_UNITPRICEEXCLVAT, null);
		$this->setFieldForeignKeyField(TTransactionsLines::FIELD_UNITPRICEEXCLVAT, null);
		$this->setFieldForeignKeyJoin(TTransactionsLines::FIELD_UNITPRICEEXCLVAT, null);
		$this->setFieldForeignKeyActionOnUpdate(TTransactionsLines::FIELD_UNITPRICEEXCLVAT, null);
		$this->setFieldForeignKeyActionOnDelete(TTransactionsLines::FIELD_UNITPRICEEXCLVAT, null);
		$this->setFieldAutoIncrement(TTransactionsLines::FIELD_UNITPRICEEXCLVAT, false);
		$this->setFieldUnsigned(TTransactionsLines::FIELD_UNITPRICEEXCLVAT, false);	
        $this->setFieldEncryptionDisabled(TTransactionsLines::FIELD_UNITPRICEEXCLVAT);		
	...
	*/
	...
	{
		return GLOBAL_DB_TABLEPREFIX.'TransactionsLines';
	}
	...
	*/
	public function getChecksumUncrypted()
	{
		return 'lekkerlijntje'.
			...
			$this->getQuantity()->getValueInternal().
			'bliekblat'.
			$this->getDescription().
			$this->getUnitPriceExclVAT()->getValueInternal().
			$this->getVATPercentage()->getValueInternal();
	}
