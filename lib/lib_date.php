 ...
 * @param $sFormatLocaleSetting string with a TLocale constant setting, i.e. TCountrySettings::DATETIME_FORMAT_REGULAR. Empty string = use default
 */
 ...
 * 
 * function needs globel $objCountrySettings to retrieve default format 
 * if parameter $sFormatLocaleSetting == ''
 *
 * @param string $sDate
 * @param $sPHPDateFormat string with a TLocale constant setting, i.e. TCountrySettings::DATEFORMAT_MEDIUM. Empty string = use default
...
function isValidDate($sDate, $sPHPDateFormat = '')
{
    ...
    if ($sPHPDateFormat == '') //use default
        $sFormat = $objCountrySettings->getCountrySetting(TCountrySettings::DATEFORMAT_DEFAULT);
    else //use parameter
 ...
 *
 * @param string $sDate
 * @param $sPHPDateFormat string with a TLocale constant setting, i.e. TCountrySettings::TIMEFORMAT_ANTEMERIDIUM_FULL. Empty string = use default
 * @global TCountrysettings $objCountrySettings
 * @return bool : true=ok, false=not valid
 */
function isValidTime($sTime, $sPHPDateFormat='') 
{
    ...
    if ($sPHPDateFormat == '') //use default
        $sFormat = $objCountrySettings->getCountrySetting(TCountrySettings::TIMEFORMAT_DEFAULT);
    else //use parameter
        $sFormat = $sPHPDateFormat;
...
//                $sFormat = $objApplication->getCountrySettings()->getCountrySetting(TCountrySettings::DATETIME_FORMAT_REGULAR);
//            else //use parameter
//                $sFormat = $objApplication->getCountrySettings()->getCountrySetting($sFormatLocaleSetting);
//
